...
INSERT IGNORE INTO user_roles(user_id, roles_id)
VALUES ((SELECT id from user where username = 'slübbers'), (SELECT id from role where role_name = 'ROLE_REGISTERED_USER'));
...
INSERT IGNORE INTO user_roles(user_id, roles_id)
VALUES ((SELECT id from user where username = 'mradke'), (SELECT id from role where role_name = 'ROLE_REGISTERED_USER'));
...
INSERT IGNORE INTO user_roles(user_id, roles_id)
VALUES ((SELECT id from user where username = 'oar'), (SELECT id from role where role_name = 'ROLE_REGISTERED_USER'));
...
INSERT IGNORE INTO user_roles(user_id, roles_id)
VALUES ((SELECT id from user where username = 'nvraux'), (SELECT id from role where role_name = 'ROLE_REGISTERED_USER'));
...
INSERT IGNORE INTO user_roles(user_id, roles_id)
VALUES ((SELECT id from user where username = 'afrö'), (SELECT id from role where role_name = 'ROLE_REGISTERED_USER'));
